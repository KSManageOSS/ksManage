...
import collections
try:
    from ksmanage_sdk.util import configUtil, HostTypeJudge, parameterConversion, RequestClient

    KSMANAGE_EXIST = True
except ImportError:
    KSMANAGE_EXIST = False
...
def main(params):
    ...
    module_impl = 'ksmanage_sdk.interface.' + impl
