...
import threading
from ksmanage_sdk.util import configUtil, RegularCheckUtil, RedfishTemplate
from ksmanage_sdk.command import backup, restore, RestFunc, IpmiFunc
import sys
import os
import json
import time
import re
from ksmanage_sdk.interface.Base import (Base, ascii2hex, hexReverse)
import collections
from ksmanage_sdk.interface.ResEntity import (ResultBean, CapabilitiesBean, CPUBean, Cpu, Memory,
...
class Common(Base):
    ...
    def gettrap(self, client, args):
        ...
        if res == {}:
            ...
            destinationlRes = Common.getDestination(self, client, None)
