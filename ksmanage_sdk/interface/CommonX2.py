...
import re
import collections
from ksmanage_sdk.util import RegularCheckUtil, RequestClient, fileUtil, configUtil, RedfishTemplate
from ksmanage_sdk.command import RestFunc, IpmiFunc, RedfishFunc
from ksmanage_sdk.interface.CommonX1 import CommonX1, addPMCLogicalDisk, addMVLogicalDisk
    ...
    def _get_xml_file(self, args):
        ...
        if args.biosversion:
            ...
            if biosformat >= 5.1000:
                return xml_path + 'X2_5.10.00.xml'
        return xml_path + 'X2.xml'
